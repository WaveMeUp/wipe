...
Version 1.0.0:
	...
	- Added dev tools (even with one tool, now you can control malloc size)
	- Select modes function
	- Changed application work scheme (now I can call it interactive)

Version 0.5.0 alpha
	- init release
	- Setup tool (set memory limit)
	- Kill your PC mode